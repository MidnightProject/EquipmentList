...
namespace EquipmentList.ViewModel
{
    public class MainViewModel : ViewModelBase
    {
        ...
        public MainViewModel()
        {
            ...
            try
            {
                employeeExtendedAdapter = new FbDataAdapter("SELECT EMPLOYEE.NAME, EMPLOYEE.PHONE, EMPLOYEE.EMAIL, EMPLOYEE.BUILDING, BUILDING.COUNTRY, BUILDING.CITY, BUILDING.ADDRESS, BUILDING.POSTCODE, PERMISSIONS.ADD_USER FROM EMPLOYEE LEFT JOIN BUILDING ON EMPLOYEE.BUILDING = BUILDING.NAME LEFT JOIN PERMISSIONS ON EMPLOYEE.ID = PERMISSIONS.ID", connection);
